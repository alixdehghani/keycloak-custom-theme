        ...
        var getSelectableYears = function (f, l) {
          ...
          $.each(self.options.selectableYears || ((pre) ? arr.reverse() : arr), function (i, v) {
            ...
            o.bind("click", function () {
              ...
              self.render();
              // const [year, month, day] = self.options.selectedDate.split('/');
              self.showDate(self.el, `${self.persianDate.year}/${self.persianDate.month}/${1}`, '', false);
              self.options.onYearClick(self.persianDate.year);
            });
        ...
        for (i = 1; i <= 12; i++) {
          ...
          if (!o.hasClass('disableMonth')) {
            o.bind("click", function () {
              ...
              // const [year, month, day] = self.options.selectedDate.split('/');
              self.showDate(self.el, `${self.persianDate.year}/${self.persianDate.month}/${1}`, '', false);
              self.options.onMonthClick(self.persianDate.month)
            });
          }
